---
name: build-page
description: Use this skill when asked to build an entire Next.js page or route for Nomad Web — covers App Router route-group selection, reading design tokens and component specs, server vs client component decisions, and the standard data-fetching pattern with cancellation guards.
---

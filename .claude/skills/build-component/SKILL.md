...
description: Use this skill when asked to build, create, or modify a React component for the Nomad web app — covers design-token lookup, file placement conventions under components/, Tailwind styling rules, and client/server component decisions.
---
